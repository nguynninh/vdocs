...
function DialogFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("mt-2 flex flex-row justify-end gap-2", className)}
      {...props}
    />
  )
}
